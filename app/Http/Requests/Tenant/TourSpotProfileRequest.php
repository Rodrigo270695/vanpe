...
/** Valida la ficha "Mi centro" (TourSpot) editada desde el subdominio del tenant. */
class TourSpotProfileRequest extends FormRequest
{
    public function authorize(): bool
    {
        return (bool) $this->user()?->can('tenant.tour_spot.manage');
    }
    ...
    {
        $spotId = app(TenantManager::class)->tenant()?->tourSpot?->id;
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            ...
            $spot = app(TenantManager::class)->tenant()?->tourSpot;
