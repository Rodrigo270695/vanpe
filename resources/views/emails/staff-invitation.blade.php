                ...
                <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;box-shadow:0 12px 30px rgba(7,68,169,.12);">
                    ...
                    <tr>
                        <td style="padding:32px;">
                            <h1 style="margin:0 0 8px;font-size:22px;color:#0744a9;">¡Hola, {{ $staffName }}!</h1>
                            <p style="margin:0 0 16px;font-size:15px;line-height:1.6;">
                                Te invitaron a formar parte del equipo de
                                <strong>{{ $restaurantName }}</strong> en VanPe.
                                @if ($roleLabel)
                                    Tu rol será <strong>{{ $roleLabel }}</strong>.
                                @endif
                            </p>
                            <p style="margin:0 0 16px;font-size:15px;line-height:1.6;">
                                Para activar tu cuenta, define tu contraseña con el siguiente botón:
                            </p>

                            <table role="presentation" cellpadding="0" cellspacing="0" style="margin:24px 0;">
                                <tr>
                                    <td style="border-radius:14px;background:#f79210;">
                                        <a href="{{ $acceptUrl }}" style="display:inline-block;padding:14px 28px;font-size:15px;font-weight:700;color:#ffffff;text-decoration:none;">
                            ...
                            <p style="margin:0;font-size:12px;color:#9ca3af;line-height:1.6;">
                                ...
                                <span style="color:#0744a9;word-break:break-all;">{{ $acceptUrl }}</span>
                            </p>
                            <p style="margin:16px 0 0;font-size:12px;color:#9ca3af;">
                                Este enlace expira en 72 horas. Si no esperabas esta invitación, ignora este mensaje.
                            </p>
                        </td>
                    </tr>
                    <tr>
